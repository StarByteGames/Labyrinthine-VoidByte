...
namespace VoidByte.Menus
{
    public class InGameMainMenu
    {
        ...
        private static void RenderColumn2()
        {
            ...
            Core.PlayerControl.CurrentPlayerControlPreset.MovementSpeed = GUI.HorizontalSlider(new Rect(157f, 96f, 128f, 20f), Core.PlayerControl.CurrentPlayerControlPreset.MovementSpeed, 4f, 20f);  
        }
